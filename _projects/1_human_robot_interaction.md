...
description: Enabling robots to understand and anticipate human behavior
...
My work in human-robot interaction focuses on enabling robots to perceive, predict, and respond to human intent. The application is not limited to industrial settings, but also healthcare and rehab.

 <!-- in shared workspaces—particularly in industrial settings where safety and efficiency depend on seamless collaboration. -->

---

<details>
<summary><strong>Human activity recognition for effective rehabilitation (Ongoing)</strong></summary>

Human activity recognition is a crucial capability for effective, AI-assisted rehabilitation. This ongoing project explores learning-based perception methods to understand and anticipate human motion, with the goal of enabling more personalized and effective rehabilitation techniques. The work is being developed in collaboration with a multidisciplinary team of health professionals and artists.
...
<details>
<summary><strong>Decentralized Perception for Human Intent Prediction — IEEE RA-L | IROS 2025</strong></summary>
