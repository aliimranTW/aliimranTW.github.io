...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/al-folio/";
          ...
          title: "Publications",
          description: "A collection of conference papers, journal articles, and workshop contributions from my doctoral studies. Go to Projects for more details about these publications.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Engagement",
          description: "Teaching, mentorship, and community outreach",
          section: "Navigation",
          handler: () => {
          ...
          title: "Projects",
          description: "Projects from my doctoral studies, organized into three primary areas of focus.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/1_human_robot_interaction/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/aliimrantw", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=a.imrantw@gmail.com", "_blank");
        },
      },{
      id: 'light-theme',
